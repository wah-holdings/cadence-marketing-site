# CAD-8755 Personality Intelligence Copy Handoff

## Narrative Spine

**Named enemy:** the remote-contributor management chasm. Distributed managers cannot reliably see how people prefer to communicate, process feedback, recover from friction, or collaborate across distance.

**Positioning shift:** do not frame this as an assessment or test. Frame it as **Personality Intelligence**: a consented signal layer that helps people understand how they work, then makes that context useful in 1:1s, coaching, and talent conversations as integrations ship.

**Customer-as-hero framing:** People leaders and managers are trying to make better conversations happen. Cadence is the guide that turns working-style signal into context, not judgment.

## Marketing-Truth Boundaries
...
**Body:** Cadence is building Personality Intelligence into 1:1 prep, coaching moments, and talent conversations. These connective workflows are shown as roadmap until each integration ships in production.

## Site Copy Implemented In This Workspace

- Product page: added `Personality Intelligence` module between Goals and 9-box.
- Pricing page: added tier and comparison references with `Coming` labels for connective use.
- Homepage: added Personality Intelligence to module grid and platform copy.
- Footer: added Product link to `Personality Intelligence`.

## Review Notes

Riley should apply the in-product copy to the product app surfaces once the relevant codebase is checked out. Quinn should review final rendered copy against the marketing-truth boundary above before any public publish or release notes.

export const heroMessaging = {
  ...
  body:
    "It turns 1:1s, goals, recognition, ER context, surveys, and culture signal into a human-owned system where AI develops managers and employees, and humans remain accountable.",
  primaryCta: {
